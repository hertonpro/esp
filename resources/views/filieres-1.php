            ...
            <div class="auto-container">
                <div class="header-upper-box clearfix">
                    <div class="upper-left pull-left">
                        <figure class="logo-box"><a href="index.php"><img src="assets/images/logo-2.png" alt=""></a></figure>
                    </div>
                                ...
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="technology-element.html">Home</a>
                                        <ul>
                                            ...
                                            <li><a href="index.php">Home Page Two</a></li>
                                            ...
                                            <li class="dropdown"><a href="technology-element.html">Header Style</a>
                                                <ul>
                                                    ...
                                                    <li><a href="index.php">Header Style Two</a></li>
                    ...
                    <div id="content_block_02">
                        <div class="content-box">
                            <div class="sec-title left">
                                <p>PROGRAMME BAC</p>
                                <h2>Licence en Sagefemme</h2>
                                <span class="separator"></span>
                            </div>
                            <div class="text">
                                <p>La formation de sage-femme est une formation universitaire qui dure cinq ans et
                                     qui permet d'obtenir le diplôme d'État de sage-femme. 
                                     Le métier de sage-femme consiste à accompagner les femmes enceintes avant, 
                                     pendant et après l'accouchement, ainsi qu'à assurer le suivi médical et 
                                     le dépistage des pathologies chez la mère et l'enfant. 
                                     La sage-femme peut exercer en milieu hospitalier, 
                                    en cabinet libéral ou en maison de naissance.</p>
                            </div>
                            ...
                            <div class="btn-box">
                                <a href="index.php" class="theme-btn style-one">Explore all Technology</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-2 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="clearfix">
                                        <li><a href="index.php">Scientific</a></li>
                                        <li><a href="index.php">Chemistry</a></li>
                                        <li><a href="index.php">Gemological</a></li>
                                        <li><a href="index.php">Forensic science</a></li>
                                        <li><a href="index.php">Immunology</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
